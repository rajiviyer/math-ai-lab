...
#         # Prior probability goes on the edge
#         dot.edge(
#             "root",
#             h_id,
#             label=f"P({hypothesis}) = {priors[hypothesis]:.2%}",
#         )

#         # Conditional likelihood goes on the edge
#         dot.edge(
#             h_id,
#             e_id,
#             label=f"P({evidence_name} | {hypothesis}) = "
#                   f"{likelihoods[hypothesis]:.2%}",
#         )

#         dot.edge(
#             h_id,
#             ne_id,
#             label=f"P({no_evidence_name} | {hypothesis}) = "
#                   f"{1 - likelihoods[hypothesis]:.2%}",
#         )

#         evidence_nodes.append((e_id, hypothesis))
...
#     for e_id, _ in evidence_nodes:
#         dot.edge(
#             e_id,
#             "posterior",
#             style="dashed",
#             label="combine evidence",
#         )
